      ...
      try {
        ...
        switch (imageModelConfig.provider) {
          ...
          case "openrouter": {
            ...
            // Search result 2 said: "Images are typically returned as base64-encoded data URLs"
            // Often inside the Markdown like ![image](data:image/...) or just the url string.
            ...
            // Regex for base64: data:image\/[a-zA-Z]+;base64,([^\"]+)
            ...
            if (mdMatch) {
              ...
              // Assume content might be just the URL/Base64 if not markdown
            ...
            if (imageUrl.startsWith("data:image")) {
              ...
              // Fallback: send as text if we couldn't parse an image
              await ctx.reply(
